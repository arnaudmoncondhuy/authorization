...
/**
 * Le contrôle d'accès de l'appelant courant, réduit à ce qu'on lui accorde — et qui retient ce
 * qu'on lui a demandé.
 *
 ...
 */
final class CallerAccessChecker implements AuthorizationCheckerInterface
{
    /** @var list<mixed> */
    public array $asked = [];
